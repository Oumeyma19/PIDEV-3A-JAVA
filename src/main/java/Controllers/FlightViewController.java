...
// Add airport names to ComboBoxes
        ...
        grid.add(new Label("Departure Date:"), 0, 2);
        grid.add(departureDatePicker, 1, 2);
        grid.add(new Label("Arrival Date:"), 0, 3);
        grid.add(arrivalDatePicker, 1, 3);
        grid.add(new Label("Price:"), 0, 4);
        grid.add(priceField, 1, 4);
        grid.add(new Label("Flight Number:"), 0, 5);
        grid.add(flightNumberField, 1, 5);
        grid.add(new Label("Departure Airport:"), 0, 6);
    ...
    private void handleDeleteFlight(Flight flight) {
        ...
        alert.setContentText("Flight Number: " + flight.getFlightNumber());
