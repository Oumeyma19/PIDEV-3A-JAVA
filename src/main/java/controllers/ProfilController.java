...
public class ProfilController {
    ...
    @FXML
    private Button toursButton; // Add this line
    ...
    private void handleTours() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/tours_view_profile.fxml"));
            Parent root = loader.load();
            Stage stage = (Stage) toursButton.getScene().getWindow();
            stage.setScene(new Scene(root));
        } catch (IOException e) {
            e.printStackTrace();
        }
