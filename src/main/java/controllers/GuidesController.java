...
public class GuidesController {
    ...
    public void initialize() {
        ...
        statusColumn.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getstatus_guideDisplay()));
    ...
    private void filterGuides() {
        ...
        filteredGuidesList.setAll(guidesList.stream()
            .filter(user -> (user.getLastname().toLowerCase().contains(query) ||
                ...
                user.getstatus_guideDisplay().toLowerCase().contains(query) ||
