...
public class UpdateReservationController {
    ...
    public void setReservation(ReservationOffre reservation) {
        ...
        startDatePicker.setValue(reservation.getstart_date());
        endDatePicker.setValue(reservation.getend_date());
    ...
    private void updateReservation() {
        try {
            reservation.setstart_date(startDatePicker.getValue());
            reservation.setend_date(endDatePicker.getValue());
