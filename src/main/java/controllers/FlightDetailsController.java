...
public class FlightDetailsController {
    ...
    private void handleBookFlight() {
        try {
            ...
            if (flight == null) {
                System.out.println("Aucun vol séléctionné!");
                Alert alert = new Alert(Alert.AlertType.WARNING);
                alert.setTitle("Attention");
                alert.setHeaderText(null);
                alert.setContentText("S'il vous plait sélectionnez un vol avant de réserver.");
                alert.showAndWait();
                return;
            }
            ...
            if (availableSeats <= 0) {
                ...
                alert.setTitle("Vol complet");
                alert.setHeaderText(null);
                alert.setContentText("Désolé , ce vol est complet!");
                alert.showAndWait();
                return;
            }
            ...
            alert.setHeaderText(null);
            alert.setContentText("Ton vol est réservé avec succés!");
            alert.showAndWait();
            ...
            alert.setHeaderText(null);
            alert.setContentText("Une erreur s'est produite lors de la réservation du vol.");
            alert.showAndWait();
        }
    }
