...
public class MainApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        btnView.setOnAction(event -> openWindow("/ViewOffres.fxml"));
        btnUpdate.setOnAction(event -> openWindow("/UpdateOffre.fxml"));
        btnDelete.setOnAction(event -> openWindow("/DeleteOffre.fxml"));
