...
public class Flight {
    ...
    public Flight(int id, String departure, String destination, Timestamp departureTime, Timestamp arrivalTime, int price, String flightNumber, Airport departureAirport, Airport arrivalAirport , int numbre_place) {
        this.id.set(id);
    ...
    public int getIdFlight() { return id.get(); }
    public void setIdFlight(int id) { this.id.set(id); }
    public IntegerProperty idFlightProperty() { return id; }
