...
public class TourService implements TService<Tour> {
    ...
    public boolean ajouter(Tour tour) throws SQLException {
        try {
            ...
            PreparedStatement ps = connection.prepareStatement(
                    "INSERT INTO tours (title, description, price, location, date, guide_id, created_at, photo, nb_place_dispo, nb_place_reserver, categorie) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
    ...
    public boolean modifier(Tour tour) {
        try {
            String sql = "UPDATE tours SET title = ?, description = ?, price = ?, location = ?, date = ?, photo = ?, nb_place_dispo = ?, categorie = ? WHERE id = ?";
        ...
        try {
            ...
            while (rs.next()) {
                Tour tour = new Tour(
                        ...
                        rs.getInt("nb_place_dispo"),
                        rs.getInt("nb_place_reserver"),
