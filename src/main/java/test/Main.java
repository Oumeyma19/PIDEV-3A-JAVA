...
public class Main {
    ...
    public static void main(String[] args) throws IncorrectPasswordException, InvalidPhoneNumberException, InvalidEmailException, EmptyFieldException, UserNotFoundException {
        ...
        guideService = GuideService.getInstance();
            ...
            // **add new user**
            //User user = new User("nada", "khalifa", "00000@gmail.com", "12345678", "Nada123", Type.CLIENT);
